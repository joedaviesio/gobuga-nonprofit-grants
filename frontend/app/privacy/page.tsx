  ...
  return (
    <div className="min-h-screen app-bg">
      <div className="max-w-2xl mx-auto px-6 py-8">
        <h1 className="text-lg font-bold text-stone-900 mb-6">Privacy & Data Policy</h1>

        <div className="card-gradient border border-stone-200 p-6 space-y-6">
          <div>
            <h2 className="text-sm font-bold text-stone-800 mb-1">What We Collect</h2>
          ...
          <div>
            <h2 className="text-sm font-bold text-stone-800 mb-1">How We Use It</h2>
            <p className="text-sm text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-sm font-bold text-stone-800 mb-1">Security</h2>
            <p className="text-sm text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-sm font-bold text-stone-800 mb-1">Your Rights</h2>
            <p className="text-sm text-stone-700 leading-relaxed">
          ...
          <div>
            <h2 className="text-sm font-bold text-stone-800 mb-1">Retention</h2>
            <p className="text-sm text-stone-700 leading-relaxed">
