    ...
    <div className="min-h-screen flex items-center justify-center auth-bg relative overflow-hidden">
      ...
      <div className="w-full max-w-md px-4 py-16 relative z-10">
        <div className="text-center mb-8">
          ...
          <p className="text-base text-stone-700 mt-2 font-[family-name:var(--font-dm-sans)]">Create your free account</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="card-gradient border border-stone-200/60 backdrop-blur-sm p-8 space-y-6 shadow-lg">
          ...
          <div>
            ...
            {touched.orgName && fieldErrors.orgName && (
              <p className="text-sm text-red-600 mt-1">{fieldErrors.orgName}</p>
            )}
          </div>

          <div>
            <label className="block text-base font-medium text-stone-700 mb-1">Website or social media URL</label>
            <input
              type="text"
              value={websiteUrl}
            ...
            {touched.websiteUrl && fieldErrors.websiteUrl && (
              <p className="text-sm text-red-600 mt-1">{fieldErrors.websiteUrl}</p>
            )}
          </div>
          ...
          <div>
            <label className="block text-base font-medium text-stone-700 mb-1">Password</label>
            <PasswordInput
              value={password}
